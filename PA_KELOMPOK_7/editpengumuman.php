...
<body id="page-top">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="editkeuangan.php">
 ...
 $id = $_GET['id'];
 $data = mysql_query("SELECT * from pengumuman where id_pengumuman='$id'");
 while($d = mysql_fetch_array($data)){
	 ?>
	 <form method="post" action="updatepengumuman.php">
		 <table>
			 <tr>			
			 ...
			 <tr>
				 <td>Deskrisi</td>
				 <td><input type="textarea" name="deskripsi" value="<?php echo $d['deskripsi']; ?>"></td>
       </tr>
       <tr>
				 <td>Tanggal</td>
				 <td><input type="text" name="tanggal_terbit" value="<?php echo $d['tanggal_terbit']; ?>"></td>
			 </tr>
			 <tr>
				 <td></td>
